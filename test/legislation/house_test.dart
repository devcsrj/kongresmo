...
import 'package:kongresmo_project/legislation/house.dart';
...
void main() {
  group('congress.gov.ph', () {
    ...
    test('.fetchBills(17)', () {
      ...
      var api = new HttpHouseBillApi(server.url);
      var legislation = api.fetchBills(17);

      expect(
          legislation,
          emitsInOrder([
            new HouseBill(17, "HB00001",
